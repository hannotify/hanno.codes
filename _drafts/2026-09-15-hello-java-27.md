...
header:
  teaser: /assets/images/blog/dumbbells.jpg
excerpt: Java 27 is like that friend that you haven't seen all summer, and when you finally see them again it's clear that they spent a lot of time in the gym. Bringing numerous improvements to performance and security, this version of Java seems to be in top shape. This post has all the info!
tags: 
- java
---
...
![Dumbbells](/assets/images/blog/dumbbells.jpg)
> Photo by Elena Kravets, from <a href="https://www.pexels.com/photo/black-dumbbells-with-5kg-labels-on-dark-background-37887280/">Pexels</a>
...
| ----------------------------------------------------------------------------------- | --------------------------------------------------------- | ----------------- | ------------- | ------------ | ----------------------------------- |
| **[523](#jep-523-make-g1-the-default-garbage-collector-in-all-environments)**       | Make G1 the Default Garbage Collector in All Environments |                   | HotSpot       | Performance  | New defaults                        |
| **[527](#jep-527-post-quantum-hybrid-key-exchange-for-tls-13)**                     | Post-Quantum Hybrid Key Exchange for TLS 1.3              |                   | Security Libs | Security     | New feature                         |
| **[531](#jep-531-lazy-constants-third-preview)**                                    | Lazy Constants                                            | Third Preview     | Core Libs     | New API      | Major                               |
| **[532](#jep-532-primitive-types-in-patterns-instanceof-and-switch-fifth-preview)** | Primitive Types in Patterns, instanceof, and switch       | Fifth Preview     | Amber         | Language     | None                                |
| **[533](#jep-533-structured-concurrency-seventh-preview)**                          | Structured Concurrency                                    | Seventh Preview   | Loom          | Concurrency  | Minor                               |
| **[534](#jep-534-compact-object-headers-by-default)**                               | Compact Object Headers by Default                         |                   | HotSpot       | Performance  | New defaults                        |
| **[536](#jep-536-jfr-in-process-data-redaction)**                                   | JFR In-Process Data Redaction                             |                   | HotSpot / JFR | Security     | New feature                         |
| **[537](#jep-537-vector-api-twelfth-incubator)**                                    | Vector API                                                | Twelfth Incubator | Core Libs     | New API      | None                                |
| **[538](#jep-538-pem-encodings-of-cryptographic-objects-third-preview)**            | PEM Encodings of Cryptographic Objects                    | Third Preview     | Security Libs | Security     | Minor                               |
