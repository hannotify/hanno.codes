...
> This example is based on Karl Heinz Marbaise's [excellent blog post on gatherers](https://dev.to/khmarbaise/jdk22-gatherer-2a6e) - do check it out if you wish to know more!
